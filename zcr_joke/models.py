...
class Tread(models.Model):
    Tread_cross = models.ManyToManyField(to=Cross,related_name='Tread_cross')
    Tread_picturescross = models.ManyToManyField(to=PicturesCross,related_name='Tread_picturescross')
    Tread_hotcross = models.ManyToManyField(to=HotCross,related_name='Tread_hotcross')
    Tread_user = models.ForeignKey('auth.User', on_delete=models.CASCADE)